      ...
      >
        <CardHeader className="flex flex-col items-center justify-center gap-4">
          ...
          <CardDescription className="font-inter text-sm text-muted-foreground">
            Submit your creatives or track previously submitted assets
          </CardDescription>
        </CardHeader>
        <CardContent className="flex items-center justify-center gap-4">
          <div className="w-1/2 flex flex-col items-center justify-center gap-4 bg-[#F9F7FF] border border-[#9B81D1] p-6 rounded-lg">
            ...
            <div className="flex flex-col items-center justify-center gap-1">
              <p className="font-inter text-lg font-semibold text-gray-900">
                Submit Creative
              </p>
              <p className="font-inter text-sm text-gray-500">
                Upload your creative for approval
              </p>
            </div>
            <Button
          ...
          <div className="w-1/2 flex flex-col items-center justify-center gap-4 bg-[#F1F9FF] border border-[#7C90CF] p-6 rounded-lg">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              {error && (
                <p
                  id="tracking-error"
                  className="text-xs text-red-500 font-inter px-1"
                  role="alert"
                >
                  {error}
                </p>
